...
// Page 1: Title
const Page1 = () => (
  <div className="h-full flex flex-col justify-center items-center relative" style={{ backgroundColor: colors.dark }}>
    <motion.div {...fadeInUp} className="text-center">
      <h1 className="text-6xl font-bold text-white mb-2" style={{ fontFamily: "Georgia, serif" }}>Procure AI</h1>
      <p className="text-xl mb-6" style={{ color: colors.iceBlue }}>Procurement Transformation Programme</p>
      <div className="w-32 h-px mx-auto mb-6" style={{ backgroundColor: colors.teal }} />
      <h2 className="text-3xl font-bold text-white mb-2" style={{ fontFamily: "Georgia, serif" }}>Executive Kick-Off Pack</h2>
      <p className="text-base mb-1" style={{ color: colors.iceBlue }}>Strategic Validation Session with Group CIO</p>
      <p className="text-sm" style={{ color: colors.slate }}>24 February 2026</p>
    </motion.div>
    <div className="absolute bottom-8 left-0 right-0 flex justify-between px-8 text-xs" style={{ color: colors.slate }}>
